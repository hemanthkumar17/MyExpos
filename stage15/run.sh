...
./expl "../$FOLDER_NAME/expl_files/even.expl"; #checked
...
# ./expl "../$FOLDER_NAME/linklist.expl"; # checked
...
# ./spl "../$FOLDER_NAME/module1_process_manager.spl"; #checked
# ./spl "../$FOLDER_NAME/module2_memory_manager.spl"; #checked
./spl "../$FOLDER_NAME/spl_files/module4_device_manager.spl"; #checked

echo Scheduler Code Compiling....
...
echo Exception Handler Code Compiling....
...
# ./xfs-interface load --int=console "../$FOLDER_NAME/console_interrupt.xsm"
# load timer interrupt
./xfs-interface load --int=timer "../$FOLDER_NAME/spl_files/timer_interrupt.xsm"
# load the disk interrupt
# ./xfs-interface load --int=disk "../$FOLDER_NAME/disk_interrupt.xsm"
# # exception handler
...
# # load int6
# ./xfs-interface load --int=6 "../$FOLDER_NAME/int6.xsm"
# # load int4
# ./xfs-interface load --int=4 "../$FOLDER_NAME/int4.xsm"
# # load int9
# ./xfs-interface load --int=9 "../$FOLDER_NAME/int9_exec.xsm"
# # load int 10
...
# ./xfs-interface load --module 1 "../$FOLDER_NAME/module1_process_manager.xsm"
# # load Module 2 - memory manager
# ./xfs-interface load --module 2 "../$FOLDER_NAME/module2_memory_manager.xsm"
...
# ./xfs-interface load --exec "../$FOLDER_NAME/linklist.xsm"
...
./xfs-interface load --exec "../$FOLDER_NAME/expl_files/even.xsm"
